...
<div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-info">List Pegawai</h6>
            </div>
            <div class="card-body">
              ...
              <div class="table-responsive">
                <div class="row"><div class="col-sm-12"><table class="table table-bordered dataTable" id="dataTable" role="grid" aria-describedby="dataTable_info" style="width: 100%;" width="100%" cellspacing="0"> 
                  ...
                  <tr role="row" class="odd">
                      ...
                      <button type="button" class="btn btn-info" data-toggle="modal" data-target="#ModalEdit{{$p->id_peg}}"><i class="fa fa-edit"></i></button>
 ...
 <!-- end form row -->
  ...
  <!-- end tab 3 -->
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-info">Ubah</button></form>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="/pegawai/hapus/{{$p->id_peg}}" class="btn btn-info">Iya</a>
      </div>
    </div>
  </div>
</div>
